...
import { CheckIcon, ExclamationTriangleIcon, PlusIcon } from "@heroicons/react/20/solid";
...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className="flex  flex-col items-center h-[485px] justify-between overflow-hidden">
        <div className="flex flex-col md:flex-row gap-4 w-full   justify-center px-3 md:px-20">
          ...
          <div
            id="draggable-el"
            className=" border-2 p-2 rounded-md hidden md:flex items-center text-center flex-col h-[484px] bg-violet-50"
          >
            <h1 className="font-bold text-lg text-center whitespace-nowrap">Drag Event</h1>
            <span className="text-xs text-gray-400">Create your recent events</span>
            ...
            <button className="bg-violet-700 flex text-white px-4 py-2 rounded-md">
            Add <PlusIcon className="h-6 w-6 ml-2" aria-hidden="true" /> 
            </button>
            </div>
          </div>
        </div>
